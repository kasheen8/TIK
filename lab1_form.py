...
class Ui_MainWindow(object): #Основной класс окна
    def setupUi(self, MainWindow):
        ...
        self.checkBox.setGeometry(QtCore.QRect(130, 60, 70, 17))
        ...
        self.spinBox_2 = QtWidgets.QDoubleSpinBox(self.layoutWidget_2)
        self.spinBox_2.setSingleStep(0.1)
        self.spinBox_2.setMaximum(1.0)
        ...
        self.label_21.setGeometry(QtCore.QRect(560, 370, 47, 13))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.lineEdit_7.setGeometry(QtCore.QRect(560, 390, 41, 20))
        self.lineEdit_7.setReadOnly(True)
        self.lineEdit_7.setObjectName("lineEdit_5")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_10.setText(_translate("MainWindow", "<html><head/><body><p>Вероятность появления</p><p>события p</p></body></html>"))
        ...
        self.checkBox.setText(_translate("MainWindow", "p=0.3"))
